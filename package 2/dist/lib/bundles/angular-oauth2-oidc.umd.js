(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['angular-oauth2-oidc'] = {}, global.ng.core, global.ng.common, global.ng.common.http, global.rxjs, global.rxjs.operators));
        ...
        OAuthService.prototype.loadDiscoveryDocument = function (fullUrl) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this.http.get(fullUrl).subscribe(function (doc) {
                    ...
                    _this.tokenEndpoint = _this.tokenEndpoint
                        ? _this.tokenEndpoint
                        : doc.token_endpoint;
            ...
            return this.checkAtHash(validationParams).then(function (atHashValid) {
                ...
                return _this.checkSignature(validationParams).then(function (_) {
                    ...
                    if (atHashCheckEnabled) {
                        return _this.checkAtHash(validationParams).then(function (atHashValid1) {
                            if (_this.requestAccessToken && !atHashValid1) {
                                var err = 'Wrong at_hash';
                                _this.logger.warn(err);
                                return Promise.reject(err);
                            }
